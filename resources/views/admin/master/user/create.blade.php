<x-layout.home title="Tambah User">

    <div class="page-heading d-flex justify-content-between align-items-center">
        <div class="judul">
            <h5 class="welcome-message">Master Data</h5>
            <h6 class="fw-bold">Tambah User Baru</h6>
        </div>
        <div class="text-end">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 text-center mb-2">
                                    <div class="d-inline-block position-relative">
                                        <img id="foto-preview" src="{{ asset('images/default-avatar.png') }}"
                                            alt="Preview Foto" class="rounded-circle border"
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="text" name="line" id="line"
                                        ...
                                        value="{{ old('line') }}" placeholder="Contoh: Line A, Line B">
                                    @error('line')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
