    ...
    public function index()
    {
        ...
        $groupedByKJ = $orders
            ...
            ->map(function ($kjOrders, $kj) {
                    ...
                    ->map(function ($poOrders, $po) {
                        ...
                        $byStyle = $poOrders
                            ...
                            ->map(function ($styleOrders, $style) {
                                ...
                                $allT = $byColor->flatMap(fn($c) => $c['by_line']->flatMap(fn($l) => $l['timbangans']));
                        ...
                        $allT = $byStyle->flatMap(fn($s) => $s['by_color']->flatMap(
                            fn($c) =>
                            $c['by_line']->flatMap(fn($l) => $l['timbangans'])
                        ));
                ...
                // Semua timbangan dalam KJ ini (lintas PO/Style/Color/Line)
